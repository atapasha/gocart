...
const Footer = () => {
  ...
  <div className="max-w-7xl mx-auto">
    <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
      ...
      <div>
        ...
        <p className="max-w-[410px] mt-6 text-sm">
          gocart'a hoş geldiniz. En yeni ve akıllı teknolojik ürünler için
          en doğru adres. Akıllı telefonlardan akıllı saatlere ve
          aksesuarlarına kadar, yeniliğin en iyisini tek bir yerde sunuyoruz.
        </p>
    ...
    <p className="py-4 text-sm text-slate-500">
      Copyright 2025 © gocart. Tüm hakları saklıdır.
    </p>
  </div>
</footer>
    );
