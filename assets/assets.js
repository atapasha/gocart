...
export const ourSpecsData = [
  {
    ...
    description:
      "Her siparişte hızlı ve ücretsiz teslimatın keyfini çıkarın. Ek şart yok, sadece güvenilir teslimat.",
    icon: SendIcon,
    accent: "#c4c7cc",
  },
  {
    ...
    description:
      "Fikrinizi mi değiştirdiniz? Sorun değil. Ürünlerinizi 7 gün içinde kolayca iade edebilirsiniz.",
  ...
  },
  {
    ...
    description:
      "Her zaman yanınızdayız. Müşteri destek ekibimizden hızlı ve profesyonel yardım alın.",
    icon: HeadsetIcon,
    accent: "#c4c7cc",
  },
];
